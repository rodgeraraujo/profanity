...
describe('censor tests', () => {
  ...
  it('should replace a bad word within a default placeholder (*)',function(){
  ...
  it('should not replace any word if there are no profane words',function(){
  ...
  it('should replace a profane word when overridden default placeholder', function(){
  ...
  it('should replace multiple instances of profane words in the same sentence', function(){
  ...
  it('should not replace anything when config.enable is false', function(){
